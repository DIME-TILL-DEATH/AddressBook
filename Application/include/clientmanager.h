...
public:
    ...
    void setConnectionSettings(const net::ConnectionArgumentsParser &newConnectionSettings);

signals:
    void contactsResponce(const std::vector<QVariant>& data);
...
private:
    ...
    void handleContactsResponsePackage(net::Package& package);
